...
//       setLoading(true);
//       const token = localStorage.getItem('token');
//       const response = await axios.get('http://3.104.77.30:8080/api/v1/project/tintuc/getAll', {
...
//       setLoading(true);
//       const token = localStorage.getItem('token');
//       const response = await axios.get('http://3.104.77.30:8080/api/v1/project/tintuc/getAllApproved', {
//         headers: { Authorization: token }
//       });
//       setNewsList(response.data.data);
//       setFilteredNews(response.data.data);
